    ...
    <div className="min-h-screen bg-[#0a0502] text-white overflow-x-hidden font-sans relative selection:bg-pink-600 selection:text-white">
      ...
      <header className="relative z-20 flex items-center justify-between px-6 md:px-10 pt-6 pb-4">
        <div className="flex items-center gap-3">
          <div className="relative group flex items-center">
            <img 
              ...
              alt="Lyrically Logo" 
              className="h-18 md:h-27 object-contain transition-all" 
              onError={(e) => { 
                e.currentTarget.style.display = 'none'; 
                const span = document.createElement('span');
                span.className = "text-2xl md:text-4xl font-bold tracking-tight text-white mb-0.5 animate-pulse bg-gradient-to-br from-pink-500 to-pink-600 bg-clip-text text-transparent";
        ...
        <nav className="flex items-center gap-4 md:gap-6">
          ...
          <button onClick={onSignUpClick} className="px-5 py-2.5 rounded-full hover:animate-pulse bg-gradient-to-br from-pink-500 to-pink-600 hover:brightness-110 hover:shadow-[0_0_20px_rgba(255,255,255,0.2)] text-white text-sm font-medium transition-all border border-pink-500 backdrop-blur-md">Get Started</button>
        </nav>
      </header>
      ...
      <main className="relative z-10 flex flex-col items-center pt-5 md:pt-10 pb-10 px-4">
        <div className="text-center max-w-5xl mx-auto flex flex-col items-center">        
          ...
          >
           From first ideas to final polish, Lyrically is there every step of the way to assist you in your creative flow.
          </motion.p>   
      ...
      <section className="border-t border-b border-white/5 bg-white/[0.02] py-8 text-center relative z-10">
          <p className="text-md md:text-lg font-bold text-gray-400 uppercase tracking-widest mb-4 flex items-center justify-center gap-2">
            ...
            <span>Where <span style={{color: '#fec200'}}><em>ideas</em></span> become finished tracks</span>
          </p>
         <div className="flex flex-wrap items-center justify-center gap-12 text-gray-500 font-semibold text-lg md:text-xl">
             <span className="flex items-center gap-2"><PlaylistIcon className="w-5 h-5"/>10,000+ songs created</span>
      ...
      {/* SECTION 2: MORE THAN A NOTEBOOK */}
      <section className="py-24 px-6 max-w-7xl mx-auto relative z-10">
         <div className="flex flex-col md:flex-row-reverse items-center gap-16">
             <div className="flex-1 space-y-8">
               <div className="inline-block px-3 py-1 bg-white/5 rounded-full border border-white/10 text-xs font-bold uppercase tracking-wider text-gray-400">More than a notenook</div>
            ...
            <div className="flex-1 w-full relative">
               ...
               <div className="relative bg-[#111] border border-white/10 rounded-3xl p-8 shadow-2xl flex flex-col gap-6">
                  ...
                  <div className="flex items-center justify-between border-b border-white/10 pb-4">
                     ...
                     <div className="flex gap-2">
                        <span className="px-3 py-1 rounded-full text-xs font-bold bg-white/10 text-white">Pop</span>
                        <span className="px-3 py-1 rounded-full text-xs font-bold bg-pink-600 text-white">Rock</span>
                        <span className="px-3 py-1 rounded-full text-xs font-bold bg-white/10 text-white">Hip-Hop</span>
                     </div>
                  </div>
      ...
      <section className="py-24 px-6 max-w-7xl mx-auto relative z-10 border-t border-white/5">
         <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-gray-400 text-lg leading-relaxed">Our industry-leading suite of AI tools ensures you always have the best tools available to take your music to new heights.
            </p>
         </div>
         <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
               { title: 'TikTok Hook Generator', icon: <TikTok className="w-8 h-8 text-[#fe2858] mb-4" /> },
               { title: 'Generate Full Songs with AI', icon: <Music className="w-8 h-8 text-yellow-500 mb-4" /> },
               { title: 'Radio-Ready Polish', icon: <Gem className="w-8 h-8 text-sky-600 mb-4" /> },
            ].map((feature, idx) => (
